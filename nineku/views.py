    ...
    if ( request.session['loginStatus'] != "success" ):
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():     ## valid input
              ...
              h.save()
              return render(request, 'upload.html', {'form': form, 'loginStatus':request.session['loginStatus']})
...
def register_success(request):
    return render(request, 'registration/success.html' , {'loginStatus':request.session['loginStatus']})

def already_confirmed(request):
    return render(request, 'registration/already_confirmed.html' , {'loginStatus':request.session['loginStatus']})
